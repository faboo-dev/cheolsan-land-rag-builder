...
-------------------------
  ...
  const getUrlForIndex = (indexStr: string, sources?: any[]) => {
      ...
      if (sources && sources[idx - 1]) {
          return sources[idx - 1].url;
      }
      return '#';
  };
                    ...
                    <div className="text-sm text-gray-800 leading-relaxed markdown-body">
                        <ReactMarkdown 
                            ...
                            components={{
                                ...
                                // Custom Link Renderer for [[1]] style citations
                                a: ({node, ...props}) => {
                                    const text = String(props.children);
                                    // Check for [[number]] pattern, generated by prompt instructions like [[1]]
                                    // Or sometimes just [1] depending on model adherence
                                    ...
                                    if (citationMatch) {
                                        ...
                                        return (
                                            <a 
                                                ...
                                                className="inline-flex items-center justify-center align-text-top mx-0.5 min-w-[16px] h-4 text-[10px] font-bold text-gray-500 bg-gray-100 border border-gray-300 rounded hover:bg-blue-100 hover:text-blue-600 hover:border-blue-300 transition-all no-underline shadow-sm"
                                    ...
                                    return <a className="text-blue-600 hover:text-blue-800 hover:underline font-medium break-all" target="_blank" rel="noopener noreferrer" {...props} />
                                },
